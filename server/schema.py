...
from .graphql.mutations.create_item import CreateItem
...
class Query(graphene.ObjectType):
    ...
    find_items = graphene.List(UserType)
    ...
    def resolve_find_items(self, info, **kwargs):
        return FindItems(info.context.user)
...
class Mutation(graphene.ObjectType):
    ...
    post_item = CreateItem.Field(description="Post an item")
